...
use crate::core::util::escape_parser::escape_dquote;
...
pub fn dquote_string_parser<'a>() -> Parser<'a, String, impl Fn(&'a [u8], usize) -> ParseResult<String> + Clone + 'a>
{
...
fn test_dqute_string() {
    let parser = dquote_string_parser();
